...
const initFormOptions = async () => {
  ...
  try {
    ...
    formState.value = {
      ...
      size: product.size,
      sizeCalculator: product.sizeCalculator
    }
...
const changeType = async (propDetailIds = []) => {
  await propertyStore.getAllByType({ type: formState.value.type })
  ...
  sortedProperties.forEach((prop) => {
    ...
    formState.value.properties[prop.id] = val
  })
